...
<div class="hero-section">
  <img src="https://Callun4.github.io/site/images/taustakevat.jpg" class="hero-bg">
  <div class="hero-overlay"></div>
  <div class="hero-content">
    <h1 class="hero-title">Kanervoita</h1>
    <p class="hero-subtitle">Ruokaa, kasveja, luontoa ja tekniikkaa. Kirjoituksia puuhailuistani</p>
    <a href="/archives.html" class="hero-btn">Selaa kirjoituksia</a>
  </div>
</div>

Heipä hei, 

Olen luonnosta ja tekniikasta kiinnostunut pian valmistuva ympäristötieteilijä. Luonteenomaisena tapana minulla on kokeilla ja katsoa mitä siitä seuraa. Kiinnostukseni kohdistuu erityisesti kasvikuntaan ja niihin liittyviin ilmiöihin. Sivun tarkka sisältö muotoutuu matkan varrella, mutta uskon että täällä jo olevat kirjoitukset luovat hyvän suunnan tulevalle.
